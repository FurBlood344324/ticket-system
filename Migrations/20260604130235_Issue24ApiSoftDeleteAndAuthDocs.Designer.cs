...
namespace TicketSupport.Migrations
{
    ...
    [Migration("20260604130235_Issue24ApiSoftDeleteAndAuthDocs")]
    partial class Issue24ApiSoftDeleteAndAuthDocs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSupport.Models.ApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TicketSupport.Models.KnowledgeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.RecurringTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.RelatedArticle", b =>
                {
            ...
            modelBuilder.Entity("TicketSupport.Models.TicketTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.TicketTimeEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.WebhookSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSupport.Models.ApiKey", b =>
                {
                    b.HasOne("TicketSupport.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TicketSupport.Models.AppUser", b =>
                {
                    ...
                    b.HasOne("TicketSupport.Models.CustomerOrganization", "Organization")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("TicketSupport.Models.RelatedArticle", b =>
                {
                    b.HasOne("TicketSupport.Models.KnowledgeArticle", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TicketSupport.Models.KnowledgeArticle", "Related")
                        .WithMany()
